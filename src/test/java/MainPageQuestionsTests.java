...
public class MainPageQuestionsTests {

    private WebDriver driver;
    private final int questionNumber;
    private final String expectedAnswer;

    public MainPageQuestionsTests(int questionNumber, String expectedAnswer) {
    ...
    public void checkAnswers() {
        String answerToQuestion = new MainPage(driver)
                .scrollPageToQuestions()
                .clickAnyQuestionButton(questionNumber)
                .returnAnswerToQuestion(questionNumber);
        assertEquals("Ответ на вопрос неверный", expectedAnswer, answerToQuestion);
    }
